...
//	        PriorityQueue<Integer> pq = new OrderedArrayPriorityQueue<Integer>(512000);
	        PriorityQueue<Integer> pq = new BinaryHeapPriorityQueue<Integer>(512000);
...
*/
	 ...
	 public static void main(String [] args) {
	        int iterations = 12;  // number of timing tests
	        int workSize = 10000;   // size of add/remove cycle loop
	        ...
	        PriorityQueue<Integer> pq = 
	        		...
	        		new BinaryHeapPriorityQueue<Integer>(5242800);
