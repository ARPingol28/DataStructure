...
public class TestUnorderedArrayPriorityQueue {
    private int [] array;
    private static final int SIZE = 100;
    private PriorityQueue<Integer> pq;
    private PriorityQueue<PrioritizedItem> pq2;    
    
    public TestUnorderedArrayPriorityQueue() {
        array = new int[SIZE];
...
//        pq2 = new OrderedArrayPriorityQueue<PrioritizedItem>(SIZE);
    ...
    private void test1() {
        pq.clear();
        for(@SuppressWarnings("unused") Integer i : pq)
...
//////////////////////////////////////////////////////////////////////////////       
    ...
    private void test5() {
        ...
        //pq = new OrderedArrayPriorityQueue<Integer>(TEST_5_SIZE);   
    ...
    public static void main(String [] args) {
        new TestUnorderedArrayPriorityQueue();
        }
    }