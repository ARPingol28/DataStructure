...
public class PgU {
	...
	public static void main(String[] args) {
		PriorityQueue<Integer> //pq = new BinaryHeapPriorityQueue<Integer>();
							   pq = new UnorderedArrayPriorityQueue<Integer>();
		...
		try {
			PriorityQueue<Item> //pq2 = new BinaryHeapPriorityQueue<Integer>();
			   pq2 = new UnorderedArrayPriorityQueue<Item>();
		...
		try {
			...
			if (pq2.size() != 5)
				System.out.println("Size error, should be 5 but is " + pq2.size());
			for (Item x : pq2)
				System.out.println(x);
			System.out.println("\n");
			...
			System.out.println("\n");
			if (pq2.size() != 0)
				System.out.println("Size error, should be 0 but is " + pq2.size());
