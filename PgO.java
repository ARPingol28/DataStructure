...
public class PgO {
    public static void main(String [] args) {
        PriorityQueue<Integer> pq = new OrderedLinkedListPriorityQueue<Integer>();
        System.out.println("Grading the OrderedArray implementation");
        try {
            for(int i=10; i > 0; i--)
                if(!pq.insert(i))
        ...
        try {
            ...
            System.out.println("Iterator should print 0 .. 10");
            for(Integer x : pq)
        ...
        try {
            PriorityQueue<Item> pq2 = new OrderedLinkedListPriorityQueue<Item>();
